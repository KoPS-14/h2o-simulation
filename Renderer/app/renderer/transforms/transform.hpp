...
namespace nitros
{
    ...
    inline auto model_matrix(const SRT &srt) -> glm::mat4{
    ...
    inline auto perspective_projection_matrix(const float& fov_y_radians, const float&  width, const float&  height, const float &near_plane, const float &far_plane )
    {
